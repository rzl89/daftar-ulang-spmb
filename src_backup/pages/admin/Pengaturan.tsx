    ...
    <div className="space-y-6 min-w-0 w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-2 min-w-0">
          {[
            { id: 'umum', label: 'Pengaturan Umum', icon: LayoutTemplate, active: true },
          ].map(item => (
            <button
              key={item.id}
        ...
        <div className="lg:col-span-2 min-w-0">
          ...
          >
            <h2 className="text-lg font-bold text-slate-800 dark:text-white mb-6">Pengaturan Umum PPDB</h2>
