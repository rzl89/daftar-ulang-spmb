...
export default function BuktiDaftarUlang() {
  ...
  return (
    <div className="w-full min-h-screen py-12 px-4 md:px-8 max-w-3xl mx-auto flex flex-col items-center">
        ...
        <div className="fixed inset-0 pointer-events-none z-50 flex items-center justify-center">
          {[...Array(20)].map((_, i) => (
            <motion.div
              ...
              className={`absolute w-3 h-3 rounded-sm ${['bg-primary', 'bg-accent', 'bg-success', 'bg-blue-400'][i % 4]}`}
            />
          ))}
        </div>
      )}
