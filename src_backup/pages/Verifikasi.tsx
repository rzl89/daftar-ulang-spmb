...
export default function Verifikasi() {
  ...
  return (
    <div className="w-full min-h-screen py-12 px-4 md:px-8 xl:max-w-6xl mx-auto flex flex-col items-center">
      ...
      <AnimatePresence mode="wait">
        ...
        {result === 'not-found' && (
          <motion.div
            ...
            className="w-full max-w-xl text-center bg-red-50 border border-red-200 text-red-700 p-4 rounded-xl"
          >
