...
export default function Beranda() {
  ...
  return (
    <div className="w-full flex flex-col pb-20">
      {/* Hero Section */}
      <section className="relative w-full min-h-[95vh] flex flex-col items-center justify-center overflow-hidden gradient-mesh-navy text-white px-6 md:px-8">
      ...
      <section className="py-20 px-6 md:px-8 w-full bg-surface-warm">
      ...
      {/* Map & Contact */}
      <section className="pb-20 pt-4 px-6 md:px-8 max-w-7xl mx-auto w-full">
